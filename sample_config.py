...
class Config(object):
    ...
    # get from any generator String Session
    ...
    TZ = os.environ.get("TZ", "Istanbul/Turkey")
    # set this with required cat repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/ForSimo/Telethon-X.git"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Telethon-X")
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/61ed5920064b54cdff6fd.jpg"
    )
