...
async def who(event):
    cat = await edit_or_reply(event, "Loading…")
...
async def fetch_info(replied_user, event):
    ...
    caption = "<b><i>• User information ⟩</i></b>\n"
    caption += f"<b>• F𝗂𝗋𝗌𝗍N𝖺𝗆𝖾 ↬</b> {first_name} {last_name}\n"
    caption += f"<b>• UserName ↬</b> {username}\n"
    caption += f"<b>• I𝖽 ↬</b> <code>{user_id}</code>\n"
    caption += (
        f"<b>• N𝗎𝗆𝖻𝖾𝗋 𝗈f 𝗉𝗁𝗈𝗍𝗈𝗌 ↬</b> {replied_user_profile_photos_count}\n"
    )
    caption += f'<b>• Account link ↬</b> <a href="tg://user?id={user_id}">{first_name}</a> \n'
    caption += f"<b>• B𝗂𝗈⁦ ↬</b> {user_bio} "
