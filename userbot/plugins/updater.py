...
if Config.UPSTREAM_REPO == "Telethon-X":
    UPSTREAM_REPO_URL = "https://github.com/ForSimo/Telethon-X"
elif Config.UPSTREAM_REPO == "ForSimo":
    UPSTREAM_REPO_URL = "https://github.com/ForSimo/Telethon-X"
else:
...
async def upstream(event):
    ...
    if conf == "" and not force_update:
        ...
        await event.delete()
        return await event.respond("do `.update deploy` to update Telethon-X.")
...
async def upstream(event):
    event = await edit_or_reply(event, "`Pulling Telethon-X repo wait a sec ....`")
    off_repo = "https://github.com/ForSimo/Telethon-pack"
    os.chdir("/app")
    catcmd = f"rm -rf .git"
    try:
...
async def variable(var):
    ...
    await edit_or_reply(var, f"`Almost ready wait for 2-3 minutes.`")
    heroku_var["UPSTREAM_REPO"] = "https://github.com/ForSimo/Telethon-X"
