...
LOGS.info("Congratulation, now type .alive to see message if bot is working \nتهانينا، انتهى التثبيت، لرؤية إذا ما كان البوت يعمل أرسل .alive")
    ...
    try:
        if Config.PRIVATE_GROUP_BOT_API_ID != 0:
            await bot.send_message(
                ...
                "Congratulation, now type .alive to see message if bot is working \nتهانينا، انتهى التثبيت، لرؤية إذا ما كان البوت يعمل أرسل .alive",
                link_preview=False,
            )
    except Exception as e:
        LOGS.info(str(e))
